    ...
    <div className="w-screen h-screen bg-center bg-no-repeat" style={{ backgroundImage: `url(${houseImage})` }}>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-8">
          <button type="button" className="text-lg border-2 border-t-0 border-l-0 border-white/25 backdrop-filter backdrop-blur-lg bg-opacity-80 shadow-md hover:bg-opacity-100 bg-lime rounded-full px-4 py-2 color text-white flex justify-evenly items-center">
            Log In
            <BiChevronRightCircle size={20} className="ml-4" />
          </button>
          <button type="button" className="text-lg border-2 border-t-0 border-l-0 border-white/25 backdrop-filter backdrop-blur-lg bg-opacity-80 shadow-md hover:bg-opacity-100 bg-lime rounded-full px-5 py-2 color text-white flex justify-evenly items-center">
            Sign Up
            <BiChevronRightCircle size={20} className="ml-4" />
          </button>
        </div>
